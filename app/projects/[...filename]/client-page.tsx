  ...
  return (
    <Section className="flex-1">
      <Container width="small" className={`flex-1 pb-2`} size="large">
        ...
        <div
          data-tina-field={tinaField(project, "author")}
          ...
          {project.author && (
            <>
              <div className="flex-shrink-0 mr-4">
                <Image
                  data-tina-field={tinaField(project.author, "avatar")}
              ...
              <p
                data-tina-field={tinaField(project.author, "name")}
      ...
      {project.heroImg && (
        <div className="px-4 w-full">
          <div
            data-tina-field={tinaField(project, "heroImg")}
      ...
      <Container className={`flex-1 pt-4`} width="small" size="large">
        <div
          data-tina-field={tinaField(project, "_body")}
          className="prose dark:prose-dark w-full max-w-none"
        >
          <TinaMarkdown
            content={project._body}
            components={{
              ...components,
            }}
          />
