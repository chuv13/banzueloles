...
title: Les Banzuelo
blocks:
  - headline: 'Les Banzuelo, Manila Philippines'
    text: |
      Les banzuelo is a graphic artist and a musician.

      created various of book covers, web banners, posters,

      packaging, catalogs and other advertisements for

      brands and companies.

      play and recorded drums for different artists such

      as stiff lu (rizal undergound), gary perez (sampaguita),

      the breed, persephone, fuseboxx, timelight panorama,

      kampon, the titos etc.

      participated in the international

      silent film festival for the italian film "i figli di nessuno"

      and currently the drummer of the band P.O.T
    text2: >
      ## Developers
